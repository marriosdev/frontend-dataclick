        ...
        <li>
            ...
            <div class="collapsible-body">
                <div>
                    ...
                    <br>
                    <span>
                        <a class="waves-effect waves-light btn-small red" v-if="!confirmarCancelarAssinatura" @click="confirmarCancelamento"><i class="material-icons left">cancel</i> Cancelar assinatura</a>
                        <a class="waves-effect waves-light btn-small orange" v-if="confirmarCancelarAssinatura" @click="cancelarAssinatura"><i class="material-icons left">cancel</i> Confirmar cancelamento</a>
                    </span>
