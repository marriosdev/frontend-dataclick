    ...
    <div class="box-button" v-if="!sucessoExclusao">
      <ul>
        <router-link :to="paginaEdicao">
          <li
            class="waves-effect waves-light btn blue button-menu"
            v-on:click="editar()"
          >
        ...
        <li
          class="waves-effect waves-light btn red button-menu"
          v-if="!botaoConfirma"
          v-on:click="excluir()"
        >
        ...
        <li
          class="waves-effect waves-light btn orange button-menu"
          v-on:click="excluirDefinitivo()"
          v-if="botaoConfirma"
        >
          <i class="material-icons left">report_problem</i>Confirmar
        </li>
      </ul>
    </div>
