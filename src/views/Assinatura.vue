      ...
      <div class="container">
        ...
        <div class="input-field col s12">
          <select v-model="usuario" class="browser-default">
            ...
            <option :value="u.id" v-for="u in usuariosLista" :key="u">
              {{ u.name }}
            </option>
          </select>
        </div>
        ...
        <div class="input-field col s12">
          <select v-model="clube" class="browser-default">
            ...
            <option :value="c.id" v-for="c in clubesLista" :key="c">
              {{ c.name }}
            </option>
          </select>
        </div>
        ...
        <div class="box-button">
          <button @click="salvar" class="waves-effect waves-light btn submit">
